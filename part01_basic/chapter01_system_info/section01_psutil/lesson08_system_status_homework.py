...
def get_system_health(
    ...
    load_1 = load_info['load_1']
    
    normalized_load_1_percent = load_info['normalized_1_percent']
    
    if normalized_load_1_percent is None:
        load_status = "未知"
    elif normalized_load_1_percent >= load_threshold:
        load_status = "警告"
    else:
        load_status = "正常"
    ...
    return {
        "boot_time": boot_time,
        "uptime": uptime,
        "logged_in_user_count": logged_in_user_count,
        "swap_percent": swap_percent,
        "swap_status": swap_status,
        "load_1": load_1,
        "normalized_load_1_percent": normalized_load_1_percent,
